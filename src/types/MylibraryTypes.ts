import {XmlmcParam, XmlmcParams, UserLibraryResourceItem, EmbeddedFileAttachment} from "./XmlmcTypes"
...
export interface getUserLibraryResourcesParams {[key: string] : XmlmcParam;}
