import {XmlmcParam, XmlmcParams, SessionVariable} from "./XmlmcTypes"
...
export interface closeLocalSessionParams {[key: string] : XmlmcParam;}
export interface convertDateTimeInTextParams {
[key: string] : XmlmcParam;
    inputText? : string;
}
export interface createLocalSessionParams {[key: string] : XmlmcParam;}
export interface getSessionDDInfoParams {[key: string] : XmlmcParam;}
...
export interface selfServiceLogoffParams {[key: string] : XmlmcParam;}
